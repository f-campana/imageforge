...
describe("package exports", () => {
  it("exposes CJS require exports for root, processor, and runner subpaths", () => {
    ...
    const script = [
      ...
      "const render = require('@imageforge/cli/render');",
      ...
      "if (typeof root.getPictureProps !== 'function') throw new Error('missing root getPictureProps export');",
      "if (typeof root.imageforgeVitePlugin !== 'function') throw new Error('missing root imageforgeVitePlugin export');",
      "if (typeof render.getPictureProps !== 'function') throw new Error('missing render getPictureProps export');",
  ...
  it("exposes ESM import exports for root, processor, and runner subpaths", () => {
    ...
    const script = [
      ...
      "import * as render from '@imageforge/cli/render';",
